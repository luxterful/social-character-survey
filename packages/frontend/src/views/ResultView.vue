...
function confirmSave() {
  mainStore.value.others.push({ name: name.value, result: resultStringBase64 })
  isOpen.value = false
}
</script>
        ...
        >
          ...
          <div class="mt-2">
            <p class="text-sm text-gray-500">
              Damit du Ergebnisse vergleichen kannst und sie richtig zuordnen kannst musst du ihnen
              einen Namen geben
            </p>
          </div>
